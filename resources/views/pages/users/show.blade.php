                    ...
                    <div class="mb-5">
                        ...
                        <div>
                            <div class="card card-discussions">
                                <div class="row">
                                    <div class="col-12 col-lg-2 mb-lg-0 d-flex flex-row flex-lg-column align-items-end">
                                            ...
                                            <div class="col me-1 me-lg-2">
                                                ...
                                                <div class="col-5 col-lg-4">
                                                    <div class="avatar-sm-wrapper d-inline-block">
                                                        <a href="#" class="me-1">
                                                        <img src="{{ url('assets/images/avatar-sm.png') }}" alt="fendy" class="avatar rounded-circle">
                                                    </a>
                                                </div>
                                                <span class="fs-12px">
