    ...
    <section class="bg-gray pt-4 pb-5">
        <div class="container">
            <div class="mb-5">
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 mb5 mb-lg-0">
                                            ...
                                            <div class="fs-12px lh-1">
                                                <span class="text-primary">
                                                    <a href="#" class="fw-bold d-flex align-items-start text-break mb-1">
                                                        MuhamadEffendyAbdullahSyadinnah
                                                    </a>
                                                </span>
                            ...
                            <div class="card card-discussion">
                                <div class="row">
                                    <div class="col-1 d-flex flex-column justify-content-start align-items-center">
                                        ...
                                        <span class="fs-4  color-gray mb-2">
                                            12
                                        </span>
                                    </div>
                                    <div class="col-11">
                                        <p>
                                           orem ipsum dolor sit amet contecstur lorem ipsum dolor sit amet contecsturlorem ipsum dolor sit amet contecsturlorem ipsum dolor sit amet contecstur 
                                        </p>
