...
@section('body')
    <section calss="bg-gray vh-100">
        <div class="container">
            <div class="row pt-5 justify-conten-center">
                <div class="col-12 col-lg-6 my-auto mb-5 mb-lg-auto me-0">
                    <div class="d-none d-lg-block">
                        <h2>Join The Laracus Comunity</h2>
                        <p>
                            <ul>
                ...
                <div class="col-12 col-lg-3 h-100">
                    ...
                    <div class="text-center">
                        Already have an account? <a href="#" class="login-link"><u>Log in</u></a> 
                    </div>
                </div>
            </div>
        </div>
